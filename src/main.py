...
def object_thread():
    ...
    :return:
    """
    diction_1 = {"MML_file1": "C:\\file1.txt", "MML_file2": "C:\\file2.txt"}
    diction_2 = {"MML_file3": "C:\\file3.txt", "MML_file4": "C:\\file4.txt"}
    first_thread = api.U2020Api(
        secret.ftp_auth,
        secret.nbi_auth,
        oss_name="first_oss",
        oss_ip="192.168.1.1",
        ftp_port=22,
        nbi_port=31331,
        dict_with_files=diction_1,
    )
    second_thread = api.U2020Api(
        secret.ftp_auth,
        secret.nbi_auth,
        oss_name="second_oss",
        oss_ip="192.168.1.2",
